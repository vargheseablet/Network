...
    alert("Database error. Please enter the field(s) again!!");
  </script> 
  <style>
.xs-collapse {
  display: none;
   ...
   <!--    <ul class="nav navbar-nav">
    ...
    <div class="col-sm-4" style=" height:745px ;width:20%; background-color:#d9d9d9; padding-right: 0px">
     ...
     <ul class="nav nav-pills nav-stacked xs-collapse" id="pills"  style=" background: #d9d9d9;"">
            ...
            <hr style="margin: 0px">
            <li class="active" role="presentation" ><a href="<?php echo base_url()?>/Bank/deposit">Deposit</a></li>
            <hr style="margin: 0px">
    ...
    <div class="container" style="margin-left: 400px; margin-top: 100px ;border:1px solid  #00001a; width: 35%; background-color: white; opacity: 0.6">
      ...
      <form name="dep_form" method="POST" action="<?php echo base_url()?>Bank/dep_auth">
        ...
        <div style="padding-left: 19%">
          <input class="buttons" type="submit" name="Deposit" value="Deposit">
        </div>
      </form> 
    </div>
</div>
